...
// ADMIN ENDPOINTS
export const EMAIL_VERIFICATION = '/send-email-verification';   // Send email verification code to admin
export const VERIFY_EMAIL = '/verify-email';                    // Verify admin email using the code
export const CHANGE_PASSWORD = '/change-password';              // Change password for logged-in admin
